...
import { ProductUpsertPricing } from '../../../../types/products/product-upsert.type';
...
export class ProductPricingComponent extends _ProductUpsertBaseComponent {

  @ViewChild('productPricingForm') form!: FrForm.FrFormComponent<ProductUpsertPricing>;
  ...
  protected override async afterViewInit(): Promise<void> {
    const model: ProductUpsertPricing = {
