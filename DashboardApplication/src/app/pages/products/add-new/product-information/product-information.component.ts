...
import { ProductInformation } from '../../../../types/products/product.type';
...
export class ProductInformationComponent extends _AddNewBaseComponent {

  @ViewChild('productInformationForm') form!: FrForm.FrFormComponent<ProductInformation>;
  ...
  protected override async afterViewInit(): Promise<void> {
    const model: ProductInformation = {
