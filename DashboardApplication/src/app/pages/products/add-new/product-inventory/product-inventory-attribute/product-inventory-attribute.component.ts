...
import { ProductAttribute } from '../../../../../types/products/product.type';
...
export class ProductInventoryAttributeComponent extends _AddNewBaseComponent {

  @ViewChild('productInventoryAttributeForm') form!: FrForm.FrFormComponent<ProductAttribute>;
