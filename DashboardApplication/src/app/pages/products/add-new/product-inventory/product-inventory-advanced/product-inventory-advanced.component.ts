...
import { ProductAdvanced } from '../../../../../types/products/product.type';
...
export class ProductInventoryAdvancedComponent extends _AddNewBaseComponent {

  @ViewChild('productInventoryAdvancedForm') form!: FrForm.FrFormComponent<ProductAdvanced>;
