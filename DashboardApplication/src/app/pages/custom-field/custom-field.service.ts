...
import { CustomFieldUpsert, CustomFieldUpsertOption } from '../../types/custom-field/custom-field-upsert.type';
...
export class CustomFieldService {
  ...
  public customFieldUpdate = this._updateCustomFieldOption.asObservable();
