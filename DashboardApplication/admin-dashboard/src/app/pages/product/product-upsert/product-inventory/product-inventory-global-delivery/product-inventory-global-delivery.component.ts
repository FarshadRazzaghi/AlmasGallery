...
export class ProductInventoryGlobalDeliveryComponent extends _ProductUpsertBaseComponent {
  ...
  @ViewChild('productInventoryGlobalDeliveryForm') form!: FrForm.FrFormComponent<ProductUpsertGlobalDelivery>;

  @Output() protected validate: EventEmitter<boolean> = new EventEmitter<boolean>();

  private subscription: Subscription;
  protected isGlobalDeliveryCountriesEnable: boolean;
  ...
  constructor(private sanitizer: DomSanitizer, elementRef: ElementRef) {
    ...
    this.isGlobalDeliveryCountriesEnable = false;
  ...
  protected override async afterViewInit(): Promise<void> {
    ...
    const model: ProductUpsertGlobalDelivery = {
