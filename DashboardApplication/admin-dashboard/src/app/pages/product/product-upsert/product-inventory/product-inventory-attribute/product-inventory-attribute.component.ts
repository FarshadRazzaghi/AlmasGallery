...
import { ProductUpsertAttribute } from '../../../../../types/product/product-upsert.type';
...
export class ProductInventoryAttributeComponent extends _ProductUpsertBaseComponent {
  ...
  protected hasExpiryDateSelected: boolean;
  protected isFrozenSelected: boolean;
  ...
  constructor(elementRef: ElementRef) {
    ...
    this.hasExpiryDateSelected = false;
    this.isFrozenSelected = false;
